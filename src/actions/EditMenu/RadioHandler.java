...
public class RadioHandler extends AbstractHandler implements IElementUpdater {
	...
	private static final String PARM_INFO = "ChangeTreeViewStatusHandler.radio";
...
//		}
//
//		String currentState = event.getParameter("ChangeTreeViewStatus.radioStateParameter");
