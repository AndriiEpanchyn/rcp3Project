...
public class a1 extends ActionBarAdvisor {
	...
	public a1(IActionBarConfigurer configurer) {
		super(configurer);
	}
...
/** Creates the actions and registers them. Registering is needed to ensure that key bindings
 work. The corresponding commands keybindings are defined in the plugin.xml file. 
